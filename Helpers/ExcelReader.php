...
// class call for the new work id generated excel sheet data reading
class ExcelReader
{
...
//insert the excel data in database 
    ...
    //Temprory data of tender after insertion deleted
...
//when new work id generated that time in single time we import the No of excel sheets given function read the data of second excel sheet
...
// Iterate over the rows up to the 36th row
...
$FHcodeStartNO = preg_replace("/[^0-9]/", '', $Mfund_head);
// dd($Mfund_head,$FHcodeStartNO);
// $FHCODEid=DB::table('fundhdms')->where('F_H_CODE',$FHcodeStartNO)->value('F_H_id');
// Check if the cleaned number is 4 digits long
// Query using the starting digits of the cleaned number
$FHCODEid = DB::table('fundhdms')->where('F_H_CODE', 'LIKE', $FHcodeStartNO . '%')->value('F_H_id');

// dd($Mfund_head,$FHcodeStartNO,$FHCODEid);
...
//when new work id generated that time in single time we import the No of excel sheets given function read the data of fourth excel sheet
